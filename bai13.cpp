...
=====================================================================================================================================================================
Bài 13: Đề bài:
Cho 4 số nguyên x, y, z, t. Như bạn đã biết, để tìm số lớn nhất và nhỏ nhất trong 2 số ta có thể sử dụng hàm max, min của thư viện <cmath>
Ngoài ra để tìm max, min của nhiều số bạn có thể sử dụng hàm max, min của thư viện <algorithm>,
ví dụ để tìm max của a, b, c có thể dùng max({a, b, c}) => chú ý đặt các biến vào trong ngoặc nhọn nếu muốn tìm max, min của 3 số trở lên.
