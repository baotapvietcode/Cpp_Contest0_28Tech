...
Bài toán này yêu cầu các bạn nhập 2 số a và b sau đó tìm phép dư khi chia a cho b.
=> Điều này được gọi là định lý số dư (remainder theorem) trong toán học.
=====================================================================================================================================================================
- Note 1:
Nếu bạn chia một số nguyên a cho một số nguyên dương N và gọi kết quả là q và số dư là r, thì ta có thể viết như sau:
                                            a = qN + r
Trong đó, q là kết quả của phép chia (thương) và r là số dư. Số dư r sẽ luôn nằm trong khoảng từ 0 đến N - 1.
...
* Trong phép chia, số bị chia là số mà chúng ta muốn chia thành các phần bằng nhau. Số chia là số mà chúng ta sử dụng để chia số bị chia. 
